/*Faça uma matriz de tamanho 3x3. Em seguida, imprima a soma dos valores contidos 
em sua diagonal segundária.*/
...
int main(){
    ...
    printf("A soma dos elementos da diagonal secundária e %d\n", soma);
    system("pause");
    return 0;
}